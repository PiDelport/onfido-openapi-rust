...
pub struct DocumentBreakdownDataConsistencyBreakdown {
    ...
    pub last_name:
        Option<Box<crate::models::DocumentBreakdownDataComparisonBreakdownIssuingCountry>>,
    #[serde(
        rename = "multiple_data_sources_present",
        skip_serializing_if = "Option::is_none"
    )]
    pub multiple_data_sources_present:
        Option<Box<crate::models::DocumentBreakdownDataComparisonBreakdownIssuingCountry>>,
}

impl DocumentBreakdownDataConsistencyBreakdown {
    pub fn new() -> DocumentBreakdownDataConsistencyBreakdown {
        DocumentBreakdownDataConsistencyBreakdown {
            ...
            nationality: None,
            last_name: None,
            multiple_data_sources_present: None,
        }
    }
}
